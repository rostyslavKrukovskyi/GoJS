...
export class Inspector {
  // private _inspectSelection: boolean;
  // private _inspectedObject: null;
  // private _properties: {};
  // _includesOwnProperties: boolean;
  // private _propertyModified: null;
  // private _multipleSelection: boolean;
  // private _showUnionProperties: boolean;
  ...
  // tabIndex: number;
  // inspectOnSelectionChanged: any;
  // inspectOnModelChanged: any;
  /**
  ...
  buildPropertyRow(propertyName, propertyValue) {
    ...
    if (decProp && decProp.type === "select") {
      ...
      if (inputi && inputi.setPointerCapture) {
        inputi.addEventListener("pointerdown", (e) =>
          inputi.setPointerCapture(e.pointerId)
        );
      }
